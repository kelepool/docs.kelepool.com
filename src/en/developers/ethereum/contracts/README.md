# How to use smart contract to staking?

## 1.Introduction

The two main functions of the contract are large pledge and small pledge. Developers can use javascript to call the contract of the cola mining pool for pledge. The contract adopts the upgradeable scheme of the open source project [Openzeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts), so `be sure to call the proxy contract To pledge `, the logic contract will be updated and replaced when ETH2.0 is launched or the function changes.
