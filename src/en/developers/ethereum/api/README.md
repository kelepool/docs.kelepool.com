...
> Request return value:
> - `date` : dividend date
> - `reward` : the reward generated by the current generation
> - `deposit` : total staked amount
> - `balance` : the total balance of the account for the current day
```json
{
    "code":0,
    "message":"success",
...
> - `date` : dividend date
> - `reward` : the reward generated by the current generation
> - `deposit` : the total staking of the account
> - `balance`: the total account balance of the day (total staking of the account + total income of the account)
```json
{
    "code":0,
    "message":"success",
