# 涨姿势：硬件钱包厂商怎样参与到 ETH Staking 浪潮中?
...
综合目前市面上的质押平台，基本上可以归纳为以下两种方式：

- 大额质押：质押数量必须是32ETH的整数倍，自己管理提款密钥，第三方管理验证节点。
- 小额质押：最低支持0.01ETH质押，第三方多签管理提款密钥及验证节点。
...
第一种前期的研发的成本很高，首先智能合约的开发审计及后端统计维护服务就很复杂，如果按照官方CLI生成BLS提款密钥的的方式来做，还要确保用户提交了验证者密钥后不会自己运行验证节点（会被罚没）。后期管理维护这些节点也需要大量的人力物力。

可乐矿池作为一站式质押管理平台，为开发人员提供了丰富的API，避免开发人员重复造轮子。智能合约经过慢雾安全人员审计，无需担心资金安全，同时还有便捷的技术支持。
...
可乐矿池支持两种质押方式，大额质押拥有独立的链上验证者节点，小额质押与其他用户共享链上验证者节点。钱包APP厂商需要帮助用户选择或者让用户自己选择下边两种质押方式。
